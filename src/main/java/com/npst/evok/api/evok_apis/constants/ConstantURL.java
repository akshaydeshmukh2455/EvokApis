...
public interface ConstantURL {
	...
	String QR_STATUS_EXTID="https://merchantuat.timepayonline.com/evok/qr/v1/qrStatus";
...
//	prod
//	String VERIFY_VPA="https://merchantprod.timepayonline.com/evok/cm/v2/verifyVPA";
//	String GENERATE_QR="https://merchantprod.timepayonline.com/evok/qr/v1/dqr";
//	String MERCHANT_TRANSFER="https://merchantprod.timepayonline.com/evok/cm/v2/transfer";
...
//	String TRANSACTION_REPORT="https://merchantprod.timepayonline.com/evok/cm/v2/report";
//	String TRANSACTION_STATUS="https://merchantprod.timepayonline.com/evok/cm/v2/status";
	
	
//	String PAYOUT="https://merchantuat.timepayonline.com/evok/cm/merchantodr/v1/payout";
	String PAYOUT="https://merchantuat.timepayonline.com/evok2/payout/api/v1/process";
